...
parser.add_argument('--save_path', type=str,
        default='./GEC_WithoutFF_saved_model/big_graph/graphnn-model', help='path for model saving')
...
if __name__ == '__main__':
    ...
    # Fix the pairs for train
    if os.path.isfile('data/train.json'):
        with open('data/train.json') as inf:
        ...
        with open('data/train.json', 'w') as outf:
    ...
    for i in range(1, MAX_EPOCH+1):
        ...
        if (i % TEST_FREQ == 0):
            ...
            if auc > best_auc:
                path = gnn.save(SAVE_PATH+'_best_block_big')
                best_auc = auc
